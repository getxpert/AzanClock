...
export default function Clock() {
    ...
    const PROFILE = {
        ...
        'portable-landscape': {
            ...
            hadithW: 'clamp(360px, 17.6vw, 256px)',
    ...
    const TopPanel = () => {
        ...
        // Responsive font: scales with viewport width and height, clamped for readability
                ...
                {rtlVakits.map((v, i) => {
                    ...
                    return (
                        <div key={i} style={{
                            ...
                            {/* Arabic name — white, on the right */}
                            <span style={{
                                fontSize: prayerFont,
                                direction: 'rtl',
                                whiteSpace: 'nowrap',
